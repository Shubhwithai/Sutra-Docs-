---
title: SUTRA-V2 with JavaScript SDK
---

This guide demonstrates how to use the **SUTRA-V2** model with the JavaScript SDK to build multilingual AI applications. SUTRA-V2, developed by TWO AI, powers chat and instruction tasks via an OpenAI-compatible API.
