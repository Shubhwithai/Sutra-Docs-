...
export const contents: Content[] = [
  ...
  },
  {
    ...
    Icon: () => (
      ...
      >
        <path
          fill="currentColor"
          d="M3 3h18v18H3V3zm16.5 1.5h-15v15h15v-15zm-6.75 6H15v1.5h-2.25V15H9v-1.5h2.25V12H9v-1.5h2.25V9H15v1.5h-2.25z"
        />
      </svg>
    ),
    list: [
      ...
      {
        title: "JavaScript",
        href: "/docs/supported-sdks/javascript",
        icon: () => (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="1.2em"
      ...
      {
        title: "React",
        href: "/docs/supported-sdks/react",
        icon: () => (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="1.2em"
      ...
      {
        title: "TypeScript",
        href: "/docs/supported-sdks/typescript",
        icon: () => (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="1.2em"
  ...
  { 
    ...
    list: [
      ...
      {
        title: "Reasoning",
        href: "/docs/Features/sutra-resoining",
        icon: Icons.book,
      },
      {
        title: "Streaming",
      ...
      {
        title: "Multilingual",
        href: "/docs/Features/sutra-multilangual",
        icon: Icons.book,
      },
      {
  ...
  },
  {
    ...
    list: [
      ...
      {
        title: "Korean",
        href: "/docs/Multilingual/Foreign-Languages/Koren",
        icon: Icons.book,
      },
      {
        title: "German",
